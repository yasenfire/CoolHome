namespace CoolHome
{
    public class InteriorSpaceConfig
    {
        ...
        public static WallSize MEDIUM = new WallSize(60f, 0.2f, 100f, 0.5f);
        public static WallSize LARGE  = new WallSize(150f, 0.4f, 800f, 0.25f);
        public static WallSize HUGE   = new WallSize(400f, 1f, 4000f, 0.05f);
        ...
        public float AuroraPower = 0f;
        public float AuroraHeaterPower = 0f;
